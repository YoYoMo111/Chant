...
function ScoreExercise(school, level, scoreFileName, size, solution, mechanism) {
...
ScoreExercise.prototype.showHint = function() {
	document.getElementById("hint").innerHTML = '<div id="hintBox" class="hintCorrect"><table id="hintTable"></table></div>';
	for (var i = 0; i < this.size; i++) {
		// Check neums
		if (this.studentsAnswerIDs[i] != "") {
...
ScoreExercise.prototype.showSymbolInfo = function(symbolID) {
	document.getElementById("hintTable").innerHTML += //yoyo add hint border
	    '<tr style="border-top: 1px dotted; border-bottom: 1px dotted; border-color: rgba(128, 128, 128, 0.57);"><td><img src="quincy/symbols/' +
		...
		'<td align="left" style="line-height: 1.7;padding-right: 30px;text-align:Justify; text-justify:inter-ideograph;">' +//yoyo add line height
